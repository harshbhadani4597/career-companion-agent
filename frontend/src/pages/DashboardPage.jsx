  ...
  return (
    <div className="space-y-8 animate-fade-in-up">
      ...
      <div className={`rounded-3xl p-8 shadow-2xl transition-all duration-300 ${
        darkMode
          ? "bg-[#0F172A] border border-blue-900/40 text-white shadow-blue-950/40"
          : "bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 text-white shadow-blue-500/20"
      }`}>
        <div className="max-w-3xl">
          <div className="flex items-center gap-3 mb-2">
            <span className="inline-flex items-center gap-1.5 bg-emerald-500/20 text-emerald-400 font-semibold px-3 py-1 rounded-full text-xs border border-emerald-500/30">
              <span className="w-2 h-2 bg-emerald-400 rounded-full animate-ping"></span>
              Live Monitoring & RAG Active
            </span>
          </div>
          <h1 className="text-3xl sm:text-4xl font-black tracking-tight mt-1 text-white">
          ...
          <div className="mt-6 flex flex-wrap gap-4">
            <button
              ...
              className="bg-white text-slate-900 hover:bg-slate-100 hover:scale-[1.02] active:scale-[0.98] px-5 py-2.5 rounded-xl font-bold text-sm shadow-md transition-all duration-200"
            >
              📄 Upload / Update Resume
            </button>
            <button
              onClick={() => setActiveTab("matching")}
              className="bg-blue-600 hover:bg-blue-500 text-white hover:scale-[1.02] active:scale-[0.98] px-5 py-2.5 rounded-xl font-bold text-sm shadow-md transition-all duration-200 border border-blue-400/30 shadow-blue-600/20"
            >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className={`p-6 rounded-3xl shadow-sm border transition-all duration-300 hover:scale-[1.02] hover:-translate-y-1 ${
          darkMode ? "bg-[#0F172A] border-slate-800/80 text-white hover:border-blue-500/40" : "bg-white border-slate-200 text-slate-900 hover:border-blue-300"
        }`}>
          ...
          <p className={`text-xs mt-2 font-medium ${darkMode ? "text-slate-400" : "text-slate-400"}`}>
        ...
        {/* Resume Status */}
        <div className={`p-6 rounded-3xl shadow-sm border transition-all duration-300 hover:scale-[1.02] hover:-translate-y-1 ${
          darkMode ? "bg-[#0F172A] border-slate-800/80 text-white hover:border-emerald-500/40" : "bg-white border-slate-200 text-slate-900 hover:border-emerald-300"
        }`}>
          <div className="flex items-center justify-between">
            <span className={`text-xs font-bold uppercase tracking-wider ${darkMode ? "text-slate-400" : "text-slate-500"}`}>
              Resume Status
        ...
        {/* Top Match Score */}
        <div className={`p-6 rounded-3xl shadow-sm border transition-all duration-300 hover:scale-[1.02] hover:-translate-y-1 ${
          darkMode ? "bg-[#0F172A] border-slate-800/80 text-white hover:border-purple-500/40" : "bg-white border-slate-200 text-slate-900 hover:border-purple-300"
        }`}>
          <div className="flex items-center justify-between">
            <span className={`text-xs font-bold uppercase tracking-wider ${darkMode ? "text-slate-400" : "text-slate-500"}`}>
              Top Match Score
        ...
        <div className={`p-6 rounded-3xl shadow-sm border transition-all duration-300 hover:scale-[1.02] hover:-translate-y-1 ${
          darkMode ? "bg-[#0F172A] border-slate-800/80 text-white hover:border-indigo-500/40" : "bg-white border-slate-200 text-slate-900 hover:border-indigo-300"
        }`}>
          <div className="flex items-center justify-between">
            <span className={`text-xs font-bold uppercase tracking-wider ${darkMode ? "text-slate-400" : "text-slate-500"}`}>
              Applications Tracked
      ...
      {topMatch && (
        <div className={`rounded-3xl p-6 sm:p-8 shadow-xl border relative overflow-hidden transition-all duration-300 hover:border-purple-500/50 ${
          darkMode ? "bg-[#0F172A] border-purple-900/40 text-white" : "bg-white border-purple-100 text-slate-900"
        }`}>
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
            <div>
              ...
              <h2 className="text-2xl font-bold mt-3 text-white">{topMatch.title}</h2>
            ...
            <div className="flex items-center gap-4">
              <div className={`text-center px-5 py-3 rounded-2xl border ${
                darkMode ? "bg-slate-900/80 border-purple-800/30" : "bg-purple-50 border-purple-100"
              }`}>
                <span className="text-3xl font-black text-purple-400 block leading-none">
          ...
          <div className={`mt-6 border-t pt-6 ${darkMode ? "border-slate-800" : "border-slate-100"}`}>
            ...
            <p className={`text-sm p-4 rounded-2xl leading-relaxed ${
              darkMode ? "bg-slate-900/60 text-slate-300 border border-slate-800" : "bg-slate-50 text-slate-600"
            }`}>
              {topMatch.reasoning}
            </p>
          </div>
